...
class Command(BaseCommand):
    ...
    def handle(self,*args,**kwargs):
        ...
        EmailCampaign.objects.get_or_create(name="Irish Heritage Collection",defaults={"subject":"Wear your Irish story","preview_text":"Discover the new Emerald Rozalia collection.","content":"<h1>Emerald Rozalia</h1><p>Our newest Irish-inspired hats and caps are ready.</p>","segment":"Active consented customers","status":"draft"})
